...
<body>
    ...
    <header id="header-area">
                ...
                <div class="row">
                    <div class="col-lg-6 col-sm-7 col-7">
                        <div class="preheader-left">
                            <a href="mailto:info@lpu.ac.ke"><strong>Email:</strong>lpualumni@gmail.com</a>
                        </div>
                    </div>

                    <div class="col-lg-6 col-sm-5 col-5 text-right">
                        <div class="preheader-right">
                            <a title="Staff login" class="btn-auth btn-auth-rev bg-success" href="/login/admin">Administration</a>
                            <a title="Alumni login" class="btn-auth btn-auth-rev bg-warning" href="/login/alumni">Alumni</a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div style="background-color: #2c3e50; !important;" class="header-bottom-area" id="fixheader">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <nav class="main-menu navbar navbar-expand-lg navbar-light">

                            <img src="{{ asset('img/logo1.png') }}" style="height: 50px; width: auto;" alt="Logo" />
    ...
    <footer id="footer-area">
        <!-- Footer Widget Start -->
        <div style="padding: 35px; background-color: #2c3e50" class="footer-widget">
            <div class="container">
                <div class="row">
                    <!-- Single Widget Start -->
                        ...
                        <div class="single-widget-wrap">
                            <div class="widgei-body">
                                <div class="footer-about">
                                    ...
                                    <p>Contact Info</p>
                                    <a href="#">Phone: 09123456892</a> <a href="#">Telephone: 007-8000</a> <br> <a href="#">Email: lpualumni@gmail.com</a>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-lg-12 text-center">
                        <div class="footer-bottom-text">
                            <p>© 2025 LPU ALUMNI SYSTEM, All Rights Reserved.</p>
                        </div>
                    </div>
                </div>
            </div>
